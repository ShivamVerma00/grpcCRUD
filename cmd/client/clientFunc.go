...
//Create Book
func BookCreate(client pb.BookManagementServiceClient, ctx context.Context) error {
	...
	response, err := client.CreateBook(ctx, &pb.ReqCreateBook{Book: NewBook})
	if err != nil {
...
//Get All Books
func GetBooks(client pb.BookManagementServiceClient, ctx context.Context) error {
	...
	stream, err := client.GetAllBooks(ctx, &pb.ReqGetAllBooks{})
	// Check for errors
	if err != nil {
...
//Update Book
func BookUpdate(client pb.BookManagementServiceClient, ctx context.Context) error {
	...
	response, err := client.UpdateBook(ctx, &pb.ReqUpdateBook{Title: updateBook.BookTitle})
	if err != nil {
...
//Delete Book
func BookDelete(client pb.BookManagementServiceClient, ctx context.Context) error {
	...
	//Call DeleteBook
	_, err = client.DeleteBook(ctx, &pb.ReqDeleteBook{BookTitle: title})
	if err != nil {
		return err
	}
...
//Search Books
func BookSearch(client pb.BookManagementServiceClient, ctx context.Context) error {

	var stream pb.BookManagementService_SearchBookClient
	...
	input = strings.TrimSpace(input)
	choice, _ := strconv.ParseInt(input, 10, 64)
	...
	case 1:
		...
		//Streaming
		stream, err = client.SearchBook(ctx, &pb.ReqSearchBook{
			Search: &pb.ReqSearchBook_BookTitle{BookTitle: title},
		})
	...
	case 2:
		...
		//Streaming
		stream, err = client.SearchBook(ctx, &pb.ReqSearchBook{
			Search: &pb.ReqSearchBook_BookAuthor{BookAuthor: author},
		})
